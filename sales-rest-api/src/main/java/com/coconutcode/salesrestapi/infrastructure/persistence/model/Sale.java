...
public class Sale extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory productCategory;
   ...
   */
  public Sale(java.lang.CharSequence productId, com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory productCategory, java.lang.Long saleDate) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: productCategory = (com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory)value$; break;
   ...
   */
  public com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory getProductCategory() {
   ...
   * @param value the value to set.
   */
  public void setProductCategory(com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory value) {
   ...
   */
  public static com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder newBuilder() {
    return new com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder();
  }
   ...
   * @return A new Sale RecordBuilder
   */
  public static com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder newBuilder(com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder other) {
    return new com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder(other);
  }
   ...
   * @return A new Sale RecordBuilder
   */
  public static com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder newBuilder(com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale other) {
    return new com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Sale>
    ...
    private com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory productCategory;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder setProductCategory(com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder clearProductCategory() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder setSaleDate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.coconutcode.salesrestapi.infrastructure.persistence.model.Sale.Builder clearSaleDate() {
    ...
    public Sale build() {
      try {
        ...
        record.productCategory = fieldSetFlags()[1] ? this.productCategory : (com.coconutcode.salesrestapi.infrastructure.persistence.model.ProductCategory) defaultValue(fields()[1]);
